...
namespace CommonLibrary.Helpers
{
    public class PredefinedQueryPatterns
    {
        ...
        public static string GET_TENANT_REPLACEMENT_JS_QUERY = "select utility.do_operations('{ \"data\": { \"domains\": {}, \"org_code\":\"\", \"library\":{} }, \"filters\": { \"tenant_id\": \"-TENANT_ID-\", \"is_deleted\": false, \"status\": {\"values\": [\"ACTIVE\",\"ACTIVE_GDPR\"], \"operator\": \"IN\"} } }'::jsonb, 'help_desk','tenant','select') as x;";
