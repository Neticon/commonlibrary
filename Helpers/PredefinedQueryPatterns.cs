namespace CommonLibrary.Helpers
{
    public class PredefinedQueryPatterns
    {
        ...
        public static string GET_VENUE_DATA_REPLACEMENT_JS_QUERY = "select utility.do_operations('{ \"data\": { \"venue_id\": \"\", \"tenant_id\": \"\", \"name\": \"\", \"city\": \"\", \"street\": \"\", \"street_number\": \"\", \"street_addition\": \"\", \"postal_code\": \"\", \"province_code\": \"\", \"province_name\": \"\", \"country_code\": \"\", \"currency_code\": \"\", \"phone\": \"\", \"email\": \"\", \"latitude\": 1.0, \"longitude\": 1.0, \"time_zone\": \"\", \"work_hours\": {}, \"min_lead_mins\": 0, \"max_adv_days\": 0, \"reasons\": {}, \"configuration\": {} , \"links\": {}, \"description\": \"\" }, \"order\": [ [\"create_dt\", \"desc\"] ], \"filters\": { \"tenant_id\": \"@tenantID\", \"enabled\": true, \"service_halt\": false, \"is_deleted\": false }, \"order\":[[\"create_dt\", \"ASC\"]] }'::jsonb, 'service_portal','venues','select') as x;";
