...
namespace CommonLibrary.Helpers
{
    ...
    {
        public static string DO_OPERATION_QUERY_PATTERN = "select utility.do_operations('{-QUERY-}'::jsonb, '-SCHEMA-','-TABLE-', '-QUERYTYPE-') as x;";
        public static string DO_SELECT_QUERY_PATTERN = "select utility.do_select('{-QUERY-}'::jsonb, '-SCHEMA-','-TABLE-') as x;";
        public static string GET_VENUE_DATA_REPLACEMENT_JS_QUERY = "select utility.do_operations('{ \"data\": { \"venue_id\": \"\", \"tenant_id\": \"\", \"name\": \"\", \"street\": \"\", \"street_number\": \"\", \"street_addition\": \"\", \"postal_code\": \"\", \"province_code\": \"\", \"province_name\": \"\", \"country_code\": \"\", \"currency_code\": \"\", \"phone\": \"\", \"email\": \"\", \"latitude\": 1.0, \"longitude\": 1.0, \"time_zone\": \"\", \"work_hours\": {}, \"min_lead_mins\": 0, \"max_adv_days\": 0, \"reasons\": {}, \"links\": {} }, \"order\": [ [\"create_dt\", \"desc\"] ], \"filters\": { \"tenant_id\": \"-TENANT_ID-\", \"enabled\": true, \"service_halt\": false, \"is_deleted\": false } }'::jsonb, 'service_portal','venues','select') as x;";
        public static string GET_TENANT_REPLACEMENT_JS_QUERY = "select utility.do_operations('{ \"data\": { \"web_pages\": {}, \"org_code\":\"\", \"library\":{} }, \"filters\": { \"tenant_id\": \"-TENANT_ID-\", \"is_deleted\": false, \"status\": {\"values\": [\"ACTIVE\",\"ACTIVE_GDPR\"], \"operator\": \"IN\"} } }'::jsonb, 'help_desk','tenant','select') as x;";
       ...
       // public static string G
        ...
        //public string ReplaceParametersInQuery(string query, List<>)
