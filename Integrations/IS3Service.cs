...
namespace CommonLibrary.Integrations
{
    public interface IS3Service
    {
        ...
        Task<string> UploadStreamAsync(string bucketName, string key, Stream stream, string uploadedBy, double? expireSeconds, bool noCache = true, bool cachePublic = false, string contentType = "application/octet-stream", CancellationToken cancellationToken = default);
